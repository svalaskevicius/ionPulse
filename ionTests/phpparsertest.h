...
private Q_SLOTS:
    ...
    void test_danglingElse() { TEST_PHP_PARSER(
        ...
        "top_statement_list(if(T_LNUMBER (@ 0:9) [text:1]; if(T_LNUMBER (@ 0:16) [text:2]; inner_statement_list(echo(echo_expr_list(T_VARIABLE (@ 0:25) [text:$y]))); elseif_list; else(inner_statement_list(echo(echo_expr_list(T_VARIABLE (@ 0:41) [text:$z]))))); elseif_list; else))"
    );}
